...
if [[ "${BASH_VERSINFO[0]}" -eq 4 && "${BASH_VERSINFO[1]}" -ge 4 || "${BASH_VERSINFO[0]}" -gt 4 ]]; then
    COMP_WORDBREAKS="" complete -o nospace -o bashdefault -o nosort -F _clap_complete_exhaustive exhaustive
else
    COMP_WORDBREAKS="" complete -o nospace -o bashdefault -F _clap_complete_exhaustive exhaustive
fi
